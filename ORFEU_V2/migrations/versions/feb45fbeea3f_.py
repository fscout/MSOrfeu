...
Revision ID: feb45fbeea3f
Revises: 
Create Date: 2021-04-21 20:43:47.916266
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('nivel_acesso', sa.String(length=13), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('troca', sa.String(length=50), nullable=True),
    sa.Column('devolucao', sa.String(length=50), nullable=True),
    sa.Column('id_venda_id', sa.Integer(), nullable=False),
