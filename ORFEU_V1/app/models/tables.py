...
class Produto(db.Model):  # Herdando da classe Model
    ...
    descricao_prod = db.Column(db.String(40), nullable=False)
    ...
    def __init__(self, cod_barras, descricao_prod, quant_prod,
                 quant_min, quant_max, preco_custo, preco_venda,
                 id_categoria_id=None, id_marca_id=None, id_medida_id=None):
        self.cod_barras = cod_barras  # Determinar valores padrões
