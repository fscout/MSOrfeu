...
Revision ID: 9288402b7dc0
Revises: 
Create Date: 2021-04-20 10:03:38.453798
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('cod_brras', sa.String(length=13), nullable=False),
